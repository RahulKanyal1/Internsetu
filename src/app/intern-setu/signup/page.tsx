...
export default function SignUpPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-100 via-purple-50 to-white flex items-center justify-center p-4 relative overflow-hidden">
      {/* Decorative sparkles */}
      <div className="absolute top-20 right-10 text-purple-400 opacity-60">
        <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
          <path d="M12 0l3.09 6.26L22 9.27l-6.91 3.01L12 24l-3.09-11.72L2 9.27l6.91-3.01L12 0z"/>
        </svg>
      </div>
      <div className="absolute bottom-32 right-20 text-blue-400 opacity-50">
        <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
          <path d="M12 0l3.09 6.26L22 9.27l-6.91 3.01L12 24l-3.09-11.72L2 9.27l6.91-3.01L12 0z"/>
        </svg>
      </div>
      <div className="absolute top-1/3 left-10 text-purple-300 opacity-40">
      ...
      >
        <div className="p-8">
          ...
          >
            <Link href="/intern-setu" className="text-sm text-purple-600 hover:underline hover:text-purple-700 transition-colors">
